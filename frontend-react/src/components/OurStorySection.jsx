      ...
      <div className="bg-gradient-to-br from-card-bg to-transparent border border-neon-blue/20 rounded-3xl p-12">
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-gray-300 leading-relaxed text-lg">
            Since 2023, founders Alhassan Bah and Mahawa Gberie have built a family of 25 committed members. Together, we organize charitable activities, educational initiatives, and community-building events that blend purpose with joy.
          </p>
